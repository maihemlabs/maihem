...
T = TypeVar("T", bound="ConversationNestedEvaluationBase")


@_attrs_define
class ConversationNestedEvaluationBase:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        conversation_nested_evaluation_base = cls(
            id=id,
            score=score,
            result=result,
        ...
        conversation_nested_evaluation_base.additional_properties = d
