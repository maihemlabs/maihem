...
T = TypeVar("T", bound="TestRunResultsMetricScoresType0")


@_attrs_define
class TestRunResultsMetricScoresType0:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        test_run_results_metric_scores_type_0 = cls()
        ...
        test_run_results_metric_scores_type_0.additional_properties = additional_properties
        return test_run_results_metric_scores_type_0
