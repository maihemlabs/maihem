...
T = TypeVar("T", bound="TestRunResultsModuleGroupScoresType0")


@_attrs_define
class TestRunResultsModuleGroupScoresType0:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        test_run_results_module_group_scores_type_0 = cls()
        ...
        test_run_results_module_group_scores_type_0.additional_properties = additional_properties
        return test_run_results_module_group_scores_type_0
