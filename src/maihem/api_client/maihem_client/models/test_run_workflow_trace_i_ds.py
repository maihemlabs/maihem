...
T = TypeVar("T", bound="TestRunWorkflowTraceIDs")


@_attrs_define
class TestRunWorkflowTraceIDs:
    """
    Attributes:
        id (str):
        ...
        workflow_trace_ids (Union[Unset, list[str]]):
    """
    ...
    workflow_trace_ids: Union[Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        workflow_trace_ids: Union[Unset, list[str]] = UNSET
        if not isinstance(self.workflow_trace_ids, Unset):
            workflow_trace_ids = self.workflow_trace_ids
        ...
        if workflow_trace_ids is not UNSET:
            field_dict["workflow_trace_ids"] = workflow_trace_ids
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        workflow_trace_ids = cast(list[str], d.pop("workflow_trace_ids", UNSET))

        test_run_workflow_trace_i_ds = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            name=name,
            ...
            links=links,
            workflow_trace_ids=workflow_trace_ids,
        )

        test_run_workflow_trace_i_ds.additional_properties = d
        return test_run_workflow_trace_i_ds
