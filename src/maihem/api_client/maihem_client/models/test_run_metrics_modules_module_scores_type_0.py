...
T = TypeVar("T", bound="TestRunMetricsModulesModuleScoresType0")


@_attrs_define
class TestRunMetricsModulesModuleScoresType0:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        test_run_metrics_modules_module_scores_type_0 = cls()
        ...
        test_run_metrics_modules_module_scores_type_0.additional_properties = additional_properties
        return test_run_metrics_modules_module_scores_type_0
