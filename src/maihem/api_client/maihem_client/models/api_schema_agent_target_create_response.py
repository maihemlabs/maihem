...
T = TypeVar("T", bound="APISchemaAgentTargetCreateResponse")


@_attrs_define
class APISchemaAgentTargetCreateResponse:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_schema_agent_target_create_response = cls(
            id=id,
            created_at=created_at,
            updated_at=updated_at,
            identifier=identifier,
        ...
        api_schema_agent_target_create_response.additional_properties = d
        return api_schema_agent_target_create_response
