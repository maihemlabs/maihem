...
T = TypeVar("T", bound="ConversationNestedTestResultMetric")


@_attrs_define
class ConversationNestedTestResultMetric:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        conversation_nested_test_result_metric = cls(
            id=id,
            result=result,
            metric_slug=metric_slug,
            score=score,
        ...
        conversation_nested_test_result_metric.additional_properties = d
        return conversation_nested_test_result_metric
