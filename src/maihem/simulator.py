...
class Simulator:
    ...
    def test(
        ...
        # Read config.yaml file
        config = cls._load_config(config_path, target_agent_identifier, test_identifier, dev_mode=False)
        ...
        test = maihem_client.upsert_test(
            ...
            name=config["maihem_agent"][test_identifier]["name"],
            maihem_agent_behavior_prompt=config["maihem_agent"][test_identifier]["behavior_prompt"],
            conversation_turns_max=config["maihem_agent"][test_identifier]["conversation_turns_max"],
            metrics_config=metrics_config
        )
