...
maihem_agent.set_static_message_list(
    ...
    ],  # Optional, list of static responses, dynamic after
)
...
maihem_agent.add_documents(
    paths=[
        "./data/journaling.txt",
        "./data/habit-building.txt",
        "./data/emotional-support.txt",
    ]
)
...
response = maihem_agent.chat(
    ...
    contexts=[
        "<Context 1>",
        "<Context 2>",
    ],  # (Optional) Pass list of contexts for RAG evaluations
)
